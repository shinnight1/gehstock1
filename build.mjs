...
function build() {
  ...
  const serverRules = ['1-daten.js', '1-sammlung.js', '1-weltkarte.js', '1-wirtschaft.js', '1-zeiten.js', '1-zusatz.js', '2-arena.js', '2-kampf.js', '2-alltag.js'].map((f) => read(path.join(SRC, 'games/gehstockmon', f)).replace(/\r\n?/g, '\n')).join('\n');
