...
(function (SG) {
  ...
  function mount(host) {
    ...
    function showAdminMenu(card,message){
      ...
      var menu=el('div',undefined,'gm-admin-menu');menu.appendChild(el('strong','Developer-Testzone'));menu.appendChild(el('p','Admin-Code eingeben, um die Insel auch während der Ruhezeit zu öffnen. Nur für echte Hideout-Admins. Alle Aktionen bleiben ungespeichert; beim Neuladen beginnt die Testzone neu.'));
